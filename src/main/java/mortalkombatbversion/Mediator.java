...
public class Mediator {
    ...
    public void setActionLabels(Fighter enemy, Fighter player, Action enemyAction, Action playerAction) {
    ...
    public void revive(Player player, Item[] items) {
        ...
        thirdItemButton.setText(items[2].getName() + ", " + items[2].getCount() + " pcs");
        playerActionLabel.setText("RESURRECTION");
    }
    ...
    public void setBagText(Item[] items) {
        firstItemButton.setText(items[0].getName() + ", " + items[0].getCount() + " pcs");
        secondItemButton.setText(items[1].getName() + ", " + items[1].getCount() + " pcs");
        thirdItemButton.setText(items[2].getName() + ", " + items[2].getCount() + " pcs");
    }
    ...
    public void setGIF(boolean a) {
        if (a) {
            GIFLabel.setIcon(new ImageIcon(getClass().getResource("/Win.gif")));
        } else {
            GIFLabel.setIcon(new ImageIcon(getClass().getResource("/fatality.gif")));
        }
    }
}
